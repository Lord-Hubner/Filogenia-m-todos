...
Algorithm for constructing phylogeny trees in Newick format and subsequently transforming them into images using similarity scores derived from sequence alignments, implemented using Python and some utilities from the Bio library